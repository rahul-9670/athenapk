# Provenance record — binary `5654eac4`

**Frozen automatically at build time by `docs/provenance/freeze.sh` on 2026-08-02 10:14:15.**

| item | value |
|---|---|
| binary | `athenapk/build_gpu/bin/athenaPK` |
| preserved copy | `athenapk/build_gpu/bin/athenaPK_PRESERVED_5654eac4` (hardlink, 0 bytes) |
| md5 | `5654eac4493f57b2d4a743d01bf32baf` |
...
**Do not delete `athenaPK_PRESERVED_5654eac4`.** It costs nothing (hardlink) and is the only
