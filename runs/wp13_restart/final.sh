...
R=/beegfs/u/bbg6470/athenapk/runs/wp13_restart/final2
...
env -C $R/straight $B -i $R/straight/fhc.in parthenon/time/nlim=12 > $R/straight/run.log 2>&1
...
env -C $R/split $B -r $R/rst.rhdf parthenon/time/nlim=12 > $R/split/run2.log 2>&1
