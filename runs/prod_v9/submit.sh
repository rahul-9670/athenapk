...
#SBATCH --output=/beegfs/u/bbg6470/athenapk/runs/prod_v9/%x_%j.out
set -o pipefail
...
# prod_v9 (2026-07-21): FRESH from t=0. Matched box L=16 + multipole gravity
# BCs (fhc.in) + binary v7 (audit fixes F1/F2/F3 + flux-kernel hardening; md5 505491e8).
# Sinks OFF. Supersedes prod_t4_full (stopped cycle 85500, kept restartable). Same CLI
# overrides as t4 (rkl2 STS + eta_ohm_cap 0.1); eta_hall_cap NOT set (priced+rejected).
BIN=/beegfs/u/bbg6470/athenapk/build_gpu/bin/athenaPK_eos_v9
WDIR=/beegfs/u/bbg6470/athenapk/runs/prod_v9
