...
OUT=diag_glm; mkdir -p $OUT
echo "=== DIAG GLM: eta_A/M(Y0) instrumentation, restart fc128b/out2.00002 t=1.100, nlim=2, binary=$(md5sum $BIN|cut -c1-8) $(date) ===" >> $OUT/run.log
