...
OUT=probe_glmadoff; mkdir -p $OUT
echo "=== GLM AD-OFF (ideal-GLM vs ideal-CT) $(date) restart out2.00002 t=1.100 -> tlim=1.10291 ===" >> $OUT/run.log
stdbuf -oL -eL mpirun -n 2 $MCA $WRAP $BIN -r fc128b/parthenon.out2.00002.rhdf -t 00:55:00 \
  ...
  hydro/divergence_control=glm diffusion/ambipolar=none \
